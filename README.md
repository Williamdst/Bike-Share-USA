...
<p align='center'> <b><i>A Simple Interpretation of the Formula: It's multiplying the portion of a station's voronoi polygon that is in a neighborhood by the population density of that neighborhood.</i></b></p>
...
<figure style="text-align:center">
    ...
    <p style="clear:both;">
    <figcaption> Figure 3. Different visulizations of the number of people served by bike stations in New York City. </figcaption>
</figure>
...
<figure style="text-align:center">
    ...
    <p style="clear:both;">
    <figcaption> Figure 4. Different visualizations of the <b> ratio </b> between people served and the voronoi area of stations in New York City</figcaption>
</figure>
